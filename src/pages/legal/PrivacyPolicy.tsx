...
export const PrivacyPolicy = () => {
  ...
  const privacyPage = getLegalPageByType('privacy');
        ...
        <div className="container mx-auto px-4 lg:px-8 py-12">
          <Card className="max-w-4xl mx-auto">
            <CardContent className="p-8 text-center">
              ...
              <h1 className="text-2xl font-bold mb-4">Politique de confidentialité non disponible</h1>
              <p className="text-muted-foreground">
                La politique de confidentialité n'est pas encore configurée.
              </p>
            ...
            <CardHeader className="text-center pb-8">
              ...
              <div className="flex items-center justify-center gap-2 text-muted-foreground mt-4">
                ...
                <span>
                  ...
                  {new Date(privacyPage.lastUpdated).toLocaleDateString(
            ...
            <CardContent className="p-8">
              ...
              <div className="mt-12 pt-8 border-t">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium mb-2">Informations de l'entreprise</h4>
